...
type UserService interface {
	...
	// InitiateReset will start the reset password process by creating the reset
	// token for the user found with the provided email.
...
// ByEMail will normalize the email address before calling ByEmail
// on the UserDB field.
